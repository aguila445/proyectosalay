...
class GuiaController extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        // Agrega aquí la lógica de autenticación y verificación de roles
        // Por ejemplo, verifica si el usuario tiene el rol de guía
        if (!$this->session->userdata('login') || $this->session->userdata('rol') !== 'Guía') {
    ...
    {
        // Lógica para la página de inicio del guía
    }
    ...
    // Agrega más acciones relacionadas con la gestión de guías aquí
}
